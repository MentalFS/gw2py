...
messages['de']['Current buy transactions of %s:'] = u'Aktuelle Einkaufstransaktionen von %s:'
messages['de']['No current buy transactions of %s.'] = u'Keine aktuellen Einkaufstransaktionen von %s.'
